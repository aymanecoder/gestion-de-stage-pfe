    ...
    if(!empty($_GET['lien'])){
        ...
        switch ($content) { 
            ...
            break;
             ...
             case 'visualiser_enseignant':
                include "pages/enseignant/visualiser_enseignant.php";
            break;
             case 'etudiant_par_enseignant':
                include "pages/division/etudiant_par_enseignant.php";
            break;
            case 'etud_sans_encad':
                include "pages/etud_encad/etud_sans_encad.php";
            break;
            case 'etud_sans_rapp':
                include "pages/etud_sans_rapport/etud_sans_rapp.php";
            break;

            case 'valider':
                include "pages/enseignant/valider.php";
            break;
            
            case 'validation_ens':
                include "pages/enseignant/validation_ens.php";
            break;
            case 'visualisation_note':
                include "pages/visualisation_note/visualisation_note.php";
            break;
            ...
            case 'stage_valide':
                include "pages/visualiser_stage/stage_valide.php";
            break;
             case 'visualiser_stage':
                include "pages/stage/visualiser_stage.php";
            break;
