    ...
    <form method="post" action="" enctype="multipart/form-data">
        <div class="container mr-5 mt-5">
            ...
            <nav class="nav nav-borders">
                ...
                <a class="nav-link" href="etudiant.php" target="__blank">etudiant</a>
            </nav>
            <div class="row ">
                <div class="col-xl-4">
...
<?php
    ...
    $cmd = $connected->query("SELECT * FROM `etudient` where apogee='". $edit."'");
...
echo "<img class=\"img-account-profile rounded-circle mb-2\" src=\"photo/$ph_name\" alt=\"photo\" width=200 height=200>";  
    $smt = $connected->prepare("UPDATE `etudient` SET photo = '".$ph_name."' WHERE apogee ='". $edit."'");
    $smt->execute();
    
    }
    if(isset($_POST['btn'])){
        $pass = $_POST['pass'];
        $cmd = $connected->prepare("UPDATE etudient SET password = '$pass' where nom = '$row1'") ; 
