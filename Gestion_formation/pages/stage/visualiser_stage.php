            ...
            <table class="table datatable">
              <thead>
                <tr>
                  ...
                  <th scope="col" width="25%">enseignant</th>
                  <th scope="col" width="10%">stage</th>
                  
                </tr>
              </thead>
              <tbody>
              <h3>  la visualisation des stages par enseignant qui l'encadre</h3>
                <?php 

                   $cmd = $connected->query("SELECT sujet.id_sujet ,enseignat.Nom,enseignat.Prénom,sujet.Intitulé_du_sujet FROM `sujet`,`enseignat` WHERE enseignat.id_ens = sujet.id_ens"); 
