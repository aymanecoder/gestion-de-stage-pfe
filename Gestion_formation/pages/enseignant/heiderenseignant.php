          ...
          <li class="nav-item dropdown pe-3">
            ...
            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
              ...
              <?php 
               ...
               $cmd = $connected->query("SELECT * FROM `enseignat` WHERE id_ens ='".$login."' ");
              ...
              ?>
                   ...
                   <? echo strtoupper("Bienvenue ".$row);?> &nbsp; <i class="bx bxs-user-circle" style="font-size: 20px;"></i> </span>
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
             ...
             <li>
                <a class="dropdown-item d-flex align-items-center" href="page.php?lien=profile_enseignant">
